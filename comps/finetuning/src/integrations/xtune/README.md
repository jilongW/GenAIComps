...
Then make `dataset_info.json` in your dataset directory, here use `caltech101` and `flickr30k` datasets as examples:
...
<table width="100%">
  ...
  <tr>
  <tr>
    <td align="center" target="_blank"><strong><img src="./pics/clip_ui.png" width=100%></strong></td>
...
<table width="100%">
  ...
  <tr>
  <tr>
    <td align="center" target="_blank"><strong><img src="./pics/adaclip_ui.png" width=100%></strong></td>
...
<table width="100%">
  <tr>
    <td align="center" colspan="1"><strong>Qwen2/2.5 -VL finetune</strong></td>
  <tr>
  <tr>
    <td align="center" target="_blank"><strong><img src="./pics/qwen_vl_ui.png" width=100%></strong></td>
...
- Must be set to the specified parameter values below:
  ...
  | Extra arguments  | Add extra arguments which is not in the UI items. When finetune Qwen2-VL or Qwen2.5-VL with Video-Q&A/Video summary dataset, you need to set `video_fps` on Extra arguments. |
  | DeepSeed stage  | Need to set to `3` when use multiple NV cards to finetune Qwen2.5-VL 32B model, set to `none` when use single card finetune. |
...
Please see [doc](./doc/Qwen-VL_README.md) for more details like optuna parameter optimization and fine-tuning eval loss visualization.
